...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: MDrv_Power_Get_PDMode
/// @brief \b Function  \b Description: Get power down mode
/// @param <IN>         \b None:
/// @param <OUT>        \b None :
/// @param <RET>        \b POWERMODE_S1,POWERMODE_S2,POWERMODE_S3,POWERMODE_S4
/// @param <GLOBAL>     \b None :
////////////////////////////////////////////////////////////////////////////////
U8 MDrv_Power_Get_PDMode(void)
{
    U8 u8Ret;
    switch(MDrv_ReadByte(PM_OFF_FLAG) & PM_PDMODE_MASK)
    {
...
{
    printf(">> MDrv_Power_ResetAndPowerUp \r\n");
